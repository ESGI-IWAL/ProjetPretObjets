...
INSERT INTO object (id, name, description, weight, dimensions, owned_by_id, state_of_wear, category, material)
VALUES (1, 'Chaise', 'Chaise en bois', 8.5, '90x45x45 cm', 1, 'GOOD', 'FURNITURE', 'WOOD');
...
INSERT INTO object (id, name, description, weight, dimensions, owned_by_id, state_of_wear, category, material)
VALUES
  (2, 'Perceuse', 'Perceuse électrique', 2.1, '30x20x8 cm', 2, 'NEW', 'TOOLS', 'METAL'),
  (3, 'Lampe', 'Lampe de chevet', 1.4, '45x18x18 cm', 2, 'GOOD', 'ELECTRONICS', 'PLASTIC'),
  (4, 'Tondeuse', 'Tondeuse de jardin', 7.8, '60x40x35 cm', 3, 'WORN', 'TOOLS', 'METAL'),
  (5, 'Table', 'Table familiale', 18.0, '140x80x75 cm', 4, 'DAMAGED', 'FURNITURE', 'WOOD'),
