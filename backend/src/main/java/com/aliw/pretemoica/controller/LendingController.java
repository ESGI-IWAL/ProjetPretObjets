...
public class LendingController {
  ...
  @PutMapping("/{id}")
  public ResponseEntity<Long> updateLending(
      @PathVariable Long id, @RequestBody UpdateLendingDto lendingDto) {
    try {
      LendingDto updated = LendingMapper.toDto(lendingService.update(id, lendingDto));
